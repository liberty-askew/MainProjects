...
public class Cat extends PromotablePiece {
  ...
  /**
   *inherits constructor from Piece via PromotablePiece to create a chick object
  ...
  */
  public ArrayList<Square> getLegalMoves() {
    ...
    if (!this.getIsPromoted()) {
      //allMoves: list of all possible moves for a cat.
      allMoves = new int[][]  {{pv, 0}, {pv, 1}, {pv, -1}, {-pv, 1}, {-pv, -1}};
    }
    else {
      //allMoves: list of all possible moves for a dog / promoted cat.
